...
const ServiceCard = ({ service, index, onSelectService }) => {
  ...
  return (
    ...
    >
      <div
        className="relative bg-card p-7 md:p-8 rounded-[2rem] h-full flex flex-col justify-between overflow-hidden cursor-pointer border border-border/80 shadow-lg shadow-black/5 transition-all duration-500"
        style={{
      ...
      >
        ...
        <div
          className={`absolute inset-0 ${bgGradient} opacity-0 group-hover:opacity-5 transition-opacity duration-500 rounded-[2rem]`}
        />
        ...
        <div className="relative z-10 mb-5">
          <div className={`w-14 h-14 rounded-2xl ${bgGradient} bg-blue-600 flex items-center justify-center shadow-lg shadow-blue-500/20 group-hover:scale-110 transition-transform duration-300`}>
...
const Services = () => {
  ...
  return (
    ...
    >
      ...
      {/* Pinned Inner Content Viewport */}
      <div className="flex flex-col h-screen justify-center py-8 md:py-12 relative z-10 overflow-hidden">
        ...
        <div className="max-w-7xl w-full mx-auto px-6 md:px-12 mb-8 md:mb-10 relative z-10 flex flex-col md:flex-row md:items-end justify-between gap-6 flex-shrink-0">
          ...
          <div className="flex items-center gap-3">
            <div className="hidden sm:flex items-center gap-3 px-4 py-2 rounded-full bg-card border border-border shadow-sm text-xs font-bold text-muted-foreground uppercase tracking-widest">
